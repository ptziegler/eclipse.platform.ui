 ...
 *******************************************************************************/
package org.eclipse.e4.ui.workbench.preferences;
...
import org.eclipse.e4.ui.internal.E4WorkbenchMessages;
	...
	public void setSearchContexts(IScopeContext[] scopes) {
		...
		for (IScopeContext scope : scopes) {
			if (scope.equals(defaultContext)) {
				Assert.isTrue(false, E4WorkbenchMessages.ScopedPreferenceStore_DefaultAddedError);
			}
		}
	}
